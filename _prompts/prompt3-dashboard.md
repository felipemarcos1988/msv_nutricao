...
Agora vamos criar o dashboard principal do sistema. Essa é a primeira tela que o nutricionista vê após fazer login.
...
- Exibe o número total de pacientes cadastrados pelo nutricionista logado
...
- Exibir apenas dados do nutricionista logado
- Se não houver pacientes sem retorno, exibir a mensagem "Nenhum paciente sem retorno no momento"

## Design
- Seguir o mesmo padrão visual da tela de autenticação
- Cards com visual limpo, moderno e profissional
- Menu lateral fixo com logotipo "MSV Nutrição" no topo